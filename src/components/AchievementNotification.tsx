    ...
    <AnimatePresence>
      {visible && achievement && (
        <motion.div
          ...
          className="fixed z-[200] pointer-events-auto top-16 left-1/2 -translate-x-1/2 w-[calc(100vw-2rem)] max-w-sm sm:top-auto sm:bottom-8 sm:left-8 sm:translate-x-0 sm:w-auto"
          onClick={() => {
            setVisible(false);
